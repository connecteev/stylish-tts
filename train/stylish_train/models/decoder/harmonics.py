# Based on the Hn-NSF project
# "Neural source-filter waveform models for statistical parametric speech synthesis":
# https://arxiv.org/pdf/1904.12088
# https://nii-yamagishilab.github.io/samples-nsf/nsf-v2.html
# https://github.com/nii-yamagishilab/project-NN-Pytorch-scripts/blob/master/project/01-nsf/hn-sinc-nsf-hifigan/model.py

import torch
import numpy as np


class HarmonicGenerator(torch.nn.Module):
    def __init__(
        self,
        *,
        sample_rate,
